...
function AddEmployee(props) {
    ...
    var modalHtmlFN =
        ...
        >
            <ModalHeader toggle={ toggleModalFN }>Employee first name invalid</ModalHeader>
    ...
    var modalHtmlUN =
        <Modal
            isOpen={ openModalUN }
            toggle={ toggleModalUN }
        >
            <ModalHeader toggle={ toggleModalUN }>Employee user name invalid</ModalHeader>
            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <div className="row justify-content-around">
                        <div className="col-md-4">
                            <div className="form-group">
                                <label className="font-weight-semibold">First Name <span className="c-failed" title="Required">*</span></label>
                                <input
                                    name="FirstName"
                                    type="text"
                    ...
                    <div className="row justify-content-around">
                        <div className="col-md-4">
                            <div className="form-group">
                                <label className="font-weight-semibold">User Name <span className="c-failed" title="Required">*</span></label>
                                <input
                                    name="FirstName"
                                    type="text"
                                    className="form-control"
                        ...
                        <div className="col-md-4">
                            <div className="form-group">
                                <label className="font-weight-semibold">Role <span className="c-failed" title="Required">*</span></label>
                    ...
                    <div className="row justify-content-around">
                        <div className="col-md-4">
                            <div className="form-group">
                                <label className="font-weight-semibold">Password <span className="c-failed" title="Required">*</span></label>
                                <input
                                    name="Password"
                                    type="password"
                                    className={ passwordValid ? "form-control input-password-valid" : "form-control input-password-invalid" }
                        ...
                        <div className="col-md-4">
                            <div className="form-group">
                                <label className="font-weight-semibold">Confirm Password <span className="c-failed" title="Required">*</span></label>
                                <input
